...
🗂 Export Output Structure
    ...
    Configured per platform via Export Options.
...
🕒 Local vs UTC
    ...
    Note: Some visual adjustments may still be refined.
...
🔹 1. True Row Count Detection
    ...
    Detect zero results directly from paging API
...
🧠 Design Principles
    ...
    No duplicate export generation
    
    Fail-safe retry logic
    
    Execution history is authoritative source
